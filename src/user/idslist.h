...
enum enID
{
  ...
  CCS_PROT_SUPPLY_OVERVOLTAGE_MODE,         /// Включение/выключение уставка
  CCS_PROT_SUPPLY_OVERVOLTAGE_REACTION,     /// Реакция защиты уставка
  ...
  CCS_PROT_SUPPLY_OVERVOLTAGE_PARAMETER_2,  /// Уставка параметр защиты
  ...
  CCS_PROT_SUPPLY_PHASE_ROTATION_REACTION,
  ...
  CCS_RGM_PERIODIC_RUN_TIME,
  CCS_RGM_PERIODIC_RUN_TIME_END,
  CCS_RGM_PERIODIC_STOP_TIME,
  CCS_RGM_PERIODIC_STOP_TIME_END,
  ...
  CCS_RGM_HEAT_CABLE_MODE,                  /// Режим Учёт нагрева кабеля вкл/откл
  ...
  CCS_RUN_DATE_TIME,                        /// Текущая наработка
  CCS_STOP_DATE_TIME,                       /// Текущий простой
  ...
  VSD_UF_CHARACTERISTIC_U_1,                /// Первая точка напряжения U/f характеристики
  VSD_UF_CHARACTERISTIC_F_1,                /// Первая точка частоты U/f характеристики
  VSD_UF_CHARACTERISTIC_U_2,                /// Вторая точка напряжения U/f характеристики
  VSD_UF_CHARACTERISTIC_F_2,                /// Вторая точка частоты U/f характеристики
  VSD_UF_CHARACTERISTIC_U_3,                /// Третья точка напряжения U/f характеристики
  VSD_UF_CHARACTERISTIC_F_3,                /// Третья точка частоты U/f характеристики
  VSD_UF_CHARACTERISTIC_U_4,                /// Четвертая точка напряжения U/f характеристики
  VSD_UF_CHARACTERISTIC_F_4,                /// Четвертая точка частоты U/f характеристики
  VSD_UF_CHARACTERISTIC_U_5,                /// Пятая точка напряжения U/f характеристики
  VSD_UF_CHARACTERISTIC_F_5,                /// Пятая точка частоты U/f характеристики
  VSD_UF_CHARACTERISTIC_U_6,                /// Шестая точка напряжения U/f характеристики
  VSD_UF_CHARACTERISTIC_F_6,                /// Шестая точка частоты U/f характеристики
  ...
  VSD_INDEX,                                /// Указатель индекса для массивных параметров Danfoss 0x0008 используется для массивов параметров
  ...
  VSD_RESONANCE_TIME,                       /// Постаянная времени подавления Danfoss 1-65 Не используется в проекте, только при конфигурировании Novomet 0x0067
  ...
  VSD_TEMP_SPEEDUP,                         /// Темп нарастания частоты
  VSD_TEMP_SPEEDDOWN,                       /// Темп замедления частоты
  VSD_END,
  TMS_BEGIN       = 15000,
  ...
  TMS_ACCELERATION_X_INTAKE,                /// Ускорение по оси Х на приёме
