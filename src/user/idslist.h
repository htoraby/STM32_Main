...
enum enID
{
  ...
  VSD_FREQ_SKIP_MODE = 10303,                                //!< Режим пропуска частот
  VSD_FREQ_SKIP_START_FREQ = 10303,                          //!< Начальная частота пропуска
  VSD_FREQ_SKIP_STOP_FREQ = 10303,                           //!< Конечная частота пропуска
  VSD_FREQ_SKIP_ACCEL = 10303,                               //!< Скорость изменения частоты при пропуске
  VSD_BLDC_KP = 10303,                                       //!< Коэффициент пропорц.рег.угла для ВД
  VSD_BLDC_KI = 10303,                                       //!< Коэффициент интегр.рег.угла для ВД
  VSD_BLDC_MAX_UP = 10303,                                   //!< Максимальная доб. верхнего предела для ВД
  VSD_END = 10303,                                           //!< 
  TMS_BEGIN = 15000,                                         //!< 
