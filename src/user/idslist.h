...
enum enID
{
  ...
  VSD_PICKUP_KU = 10263,                                     //!< Коэффициент U по подхвату
  VSD_ENGINE_DECEL_MODE = 10264,                             //!< Контроль турбинного вращения
  VSD_BLDC_K_MTZ = 10265,                                    //!< Коэффициент мгновенной токовой защиты
  VSD_COEF_VOLTAGE_IN_AB = 10266,                            //!< Коэффициент коррекции напряжения Uab
  VSD_COEF_VOLTAGE_IN_BC = 10267,                            //!< Коэффициент коррекции напряжения Ubс
  VSD_COEF_VOLTAGE_IN_CA = 10268,                            //!< Коэффициент коррекции напряжения Uсa
  VSD_COEF_VOLTAGE_IN_DC = 10269,                            //!< Коэффициент коррекции напряжения Udc
  VSD_COEF_CURRENT_IN_DC = 10270,                            //!< Коэффициент коррекции тока Idc
  VSD_COEF_VOLTAGE_OUT_1 = 10271,                            //!< Коэф. корр. показ.напряжения Uвых
  VSD_COEF_VOLTAGE_OUT_2 = 10272,                            //!< Коэффициент корр.напряжения Uвых
  VSD_TRANS_VOLTAGE_TAP_OFF = 10273,                         //!< Напряжение отпайки
  ...
  VSD_BLDC_MAX_ANGLE = 10286,                                //!< Максимальный угол дельта тета положения ротора для ВД
  VSD_ENGINE_U_OUT_STABLE = 10287,                           //!< Стабилизация выходного напряжения
  VSD_ETALON_START_TYPE = 10288,                             //!< Вид пуска {"Плавный": 0, "Толчок": 1, "Расклин": 2}
  VSD_RGM_RUN_PUSH_UPTIME = 10289,                           //!< Время подъема толчка
  VSD_END = 10290,                                           //!< 
  TMS_BEGIN = 15000,                                         //!< 
