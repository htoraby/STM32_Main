...
enum enID
{
  ...
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_MODE = 967,           //!< Перегрев фильтра
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_PREVENT = 968,        //!< Перегрев фильтра.Запрещ.парам.
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_ACTIV_DELAY = 969,    //!< Перегрев фильтра. Пуск.время
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_TRIP_DELAY = 970,     //!< Перегрев фильтра. Время
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_RESTART_DELAY = 971,  //!< Перегрев фильтра. Зад.АПВ
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_RESTART_LIMIT = 972,  //!< Перегрев фильтра. Раз.АПВ
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_RESTART_RESET = 973,  //!< Перегрев фильтра. Сброс счёт.
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_TRIP_SETPOINT = 974,  //!< Перегрев фильтра. Уст.остан.
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_RESTART_SETPOINT = 975, //!< Перегрев фильтра. Уст.пуска
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_PARAMETER = 976,      //!< Перегрев фильтра. Параметр
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_RESTART_FLAG = 977,   //!< Перегрев фильтра. Флаг АПВ
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_STATE = 978,          //!< Перегрев фильтра Состояние
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_TIME = 979,           //!< Перегрев фильтра Таймер
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_RESTART_COUNT = 980,  //!< Перегрев фильтра Время АПВ
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_RESTART_FIRST_TIME = 981, //!< Перегрев фильтра Счёт. АПВ
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_DELAY_FLAG = 982,     //!< Перегрев фильтра. Флаг срабатывания
  CCS_PROT_OTHER_OVERHEAT_INPUT_FILTER_BLOCK_FLAG = 983,     //!< Перегрев фильтра. Флаг блок.
  CCS_CMD_PROT_OTHER_OVERHEAT_INPUT_FILTER_SETPOINT_RESET = 984, //!< Перегрев фильтра. Сброс уставок
