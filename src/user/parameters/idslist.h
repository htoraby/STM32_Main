...
enum enID
{
  ...
  CCS_PROT_SUPPLY_POWEROFF_PREVENT = 873,                    //!< Защита Отключение питания. Параметр запрещающий запуск
  CCS_PROT_SUPPLY_POWEROFF_RESTART_FLAG = 874,               //!< Защита Отключение питания. Текущий параметр Флаг что защита в АПВ
  CCS_PROT_SUPPLY_POWEROFF_STATE = 875,                      //!< Защита Отключение питания. Текущий параметр состояние автомата
  CCS_END = 876,                                             //!< Последний параметр
