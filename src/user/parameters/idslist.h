...
enum enID
{
  ...
  CCS_CMD_SAVE_SETPOINT = 1075,                              //!< Конфигурации. Сохранение конфигурации в профиль
  CCS_CMD_LOAD_SETPOINT = 1076,                              //!< Конфигурации. Загрузка конфигурации из профиля
  ...
  CCS_AI_5_ZERO_SHIFT = 1080,                                //!< Смещение нуля аналогового входа 5
  CCS_AI_5_AXIS_ZERO_SHIFT = 1081,                           //!< Ось смещения аналогового входа 5
  CCS_AI_5_COEF = 1082,                                      //!< Калибровочный коэффициент аналогового входа 5
  CCS_AI_6_AXIS_ZERO_SHIFT = 1083,                           //!< Ось смещения аналогового входа 6
  CCS_AI_7_AXIS_ZERO_SHIFT = 1084,                           //!< Ось смещения аналогового входа 7
  CCS_AI_8_AXIS_ZERO_SHIFT = 1085,                           //!< Ось смещения аналогового входа 8
  CCS_AI_1_ZERO_SHIFT = 1086,                                //!< Смещение нуля аналогового входа 1
  CCS_AI_1_AXIS_ZERO_SHIFT = 1087,                           //!< Ось смещения аналогового входа 1
  CCS_AI_1_COEF = 1088,                                      //!< Калибровочный коэффициент аналогового входа 1
  CCS_AI_2_ZERO_SHIFT = 1089,                                //!< Смещение нуля аналогового входа 2
  CCS_AI_2_AXIS_ZERO_SHIFT = 1090,                           //!< Ось смещения аналогового входа 2
  CCS_AI_2_COEF = 1091,                                      //!< Калибровочный коэффициент аналогового входа 2
  CCS_AI_3_ZERO_SHIFT = 1092,                                //!< Смещение нуля аналогового входа 3
  CCS_AI_3_AXIS_ZERO_SHIFT = 1093,                           //!< Ось смещения аналогового входа 3
  CCS_AI_3_COEF = 1094,                                      //!< Калибровочный коэффициент аналогового входа 3
  CCS_AI_4_ZERO_SHIFT = 1095,                                //!< Смещение нуля аналогового входа 4
  CCS_AI_4_AXIS_ZERO_SHIFT = 1096,                           //!< Ось смещения аналогового входа 4
  CCS_AI_4_COEF = 1097,                                      //!< Калибровочный коэффициент аналогового входа 4
  CCS_END = 1098,                                            //!< 
