...
enum enID
{
  ...
  VSD_PROT_NO_CONNECT_MODE = 10356,                          //!< "Защита от потери связи с ЧРП"
  VSD_PROT_NO_CONNECT_TRIP_DELAY = 10357,                    //!< Защита от потери связи с ЧРП. Задержка срабатывания уставка
  VSD_END = 10358,                                           //!< 
  TMS_BEGIN = 15000,                                         //!< 
