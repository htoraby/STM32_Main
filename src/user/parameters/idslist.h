...
enum enID
{
  ...
  CCS_VSD_STATUS_WORD_1_LOG = 886,                           //!< Регистр состояния инвертора
  CCS_VSD_STATUS_WORD_2_LOG = 887,                           //!< Регистр состояния инвертора
  CCS_VSD_STATUS_WORD_7_LOG = 888,                           //!< Регистр состояния инвертора
  CCS_VSD_CONNECTION_PERCENT = 889,                          //!< Последний параметр
  CCS_VSD_CONNECTION_PACKAGE_TOTAL = 890,                    //!< 
  CCS_VSD_CONNECTION_PACKAGE_SUCCESS = 891,                  //!< 
  CCS_VSD_CONNECTION_PACKAGE_TRASH = 892,                    //!< 
  CCS_VSD_CONNECTION_PACKAGE_CRC = 893,                      //!< 
  CCS_VSD_CONNECTION_PACKAGE_ERR = 894,                      //!< 
  CCS_VSD_CONNECTION_PACKAGE_LOST = 895,                     //!< 
  CCS_VSD_CONNECTION_SPEED = 896,                            //!< 
  CCS_VSD_CONNECTION_ADDRESS = 897,                          //!< 
  CCS_VSD_CONNECTION_PARITY = 898,                           //!< 
  CCS_VSD_CONNECTION_STOP_BIT = 899,                         //!< 
  CCS_END = 900,                                             //!< Последний параметр
