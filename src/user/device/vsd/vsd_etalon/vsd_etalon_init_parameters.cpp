...
void VsdEtalon::initModbusParameters()
{
  ...
  modbusParameters_[134] = {// Режим токоограничения
                            VSD_ETALON_CURRENT_LIMITATION_MODE,
                            325 + 0x4000,     // Адрес регистра в устройстве
                            OPERATION_WRITE,  // Операции с параметром
                            PHYSIC_NUMERIC,   // Физическая величина параметра
                            NUMERIC_NUMBER,   // Единицы измерения параметра
                            TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[135] = {// Порог токоограничения
                            VSD_ETALON_CURRENT_LIMITATION_LIMIT,
                            324 + 0x4000,     // Адрес регистра в устройстве
                            OPERATION_WRITE,  // Операции с параметром
                            PHYSIC_CURRENT,   // Физическая величина параметра
                            CURRENT_A,        // Единицы измерения параметра
                            TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[136] = {// Задержка отключения токоограничения
                            VSD_ETALON_CURRENT_LIMITATION_DELAY,
                            333 + 0x4000,     // Адрес регистра в устройстве
                            OPERATION_WRITE,  // Операции с параметром
                            PHYSIC_TIME,      // Физическая величина параметра
                            TIME_SS,          // Единицы измерения параметра
                            TYPE_DATA_INT16,  // Тип данных
