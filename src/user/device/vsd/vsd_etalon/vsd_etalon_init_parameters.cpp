...
void VsdEtalon::initModbusParameters()
{
  ...
  modbusParameters_[6] = {// Температура1 IGBT модуля
                          ...
                          1,                // Коэффициент преобразования параметра
                          0,                // Минимальное значение параметра
                          999,              // Максимально значение параметра
                          0,                // Считываемое значение "по умолчанию"
                          EVERY_TIME,       // Частота опроса параметра
                          EVERY_TIME,       // Количество запросов к параметру
                          OPERATION_ERROR,  // Команда
  ...
  modbusParameters_[17] = {// Текущее выходное напряжение ПЧ
                           ...
                           1,               // Коэффициент преобразования параметра
                           0,               // Минимальное значение параметра
                           700,             // Максимально значение параметра
                           0,               // Считываемое значение "по умолчанию"
                           EVERY_TIME,      // Частота опроса параметра
                           EVERY_TIME,      // Количество запросов к параметру
                           OPERATION_ERROR, // Команда
  ...
  modbusParameters_[34] = {// Номинальные обороты ПЭД ("VSD_BLDC Speed Rating") нужен для ВД
                           ...
                           3000,            // Считываемое значение "по умолчанию"
                           OFTEN,          // Частота опроса параметра
                           OFTEN,          // Количество запросов к параметру
                           OPERATION_ERROR, // Команда
                           VALIDITY_ERROR,  // Поле состояния параметра
  ...
  modbusParameters_[51] = {//Верхний предел регулирования для ВД
                           ...
                           35,              // Считываемое значение "по умолчанию"
                           OFTEN,          // Частота опроса параметра
                           OFTEN,          // Количество запросов к параметру
                           OPERATION_ERROR, // Команда
                           VALIDITY_ERROR,  // Поле состояния параметра
  ...
  modbusParameters_[58] = {// Верхняя граница частоты
                           ...
                           100,             // Минимальное значение параметра
                           5000,            // Максимально значение параметра
                           601,             // Считываемое значение "по умолчанию"
                           OFTEN,     // Частота опроса параметра
                           OFTEN,     // Количество запросов к параметру
                           OPERATION_ERROR, // Команда
                           VALIDITY_ERROR,  // Поле состояния параметра
  ...
  modbusParameters_[77] = {// Частота ШИМ (для ВД = 5000, для АС = 3235)
                           ...
                           0,                // Индекс
                           0.001,           // Коэффициент преобразования параметра
                           1200,            // Минимальное значение параметра
                           5000,            // Максимально значение параметра
  ...
  modbusParameters_[89] = {// Частота U/f двигателя, точка u1
                           ...
                           0,               // Минимальное значение параметра
                           10000,           // Максимально значение параметра
                           125,             // Считываемое значение "по умолчанию"
                           OFTEN,     // Частота опроса параметра
                           OFTEN,     // Количество запросов к параметру
                           OPERATION_ERROR, // Команда
                           VALIDITY_ERROR,  // Поле состояния параметра
  ...
  modbusParameters_[95] = {// Частота U/f двигателя, точка u4
                           ...
                           0,               // Минимальное значение параметра
                           10000,           // Максимально значение параметра
                           750,             // Считываемое значение "по умолчанию"
                           OFTEN,           // Частота опроса параметра
                           OFTEN,           // Количество запросов к параметру
                           OPERATION_ERROR, // Команда
                           VALIDITY_ERROR,  // Поле состояния параметра
  ...
  modbusParameters_[103] = {// Конечная частота пропуска
                            ...
                            350,            // Минимальное значение параметра
                            5000,           // Максимально значение параметра
                            490,            // Считываемое значение "по умолчанию"
                            OFTEN,         // Частота опроса параметра
                            OFTEN,         // Количество запросов к параметру
                            OPERATION_ERROR,// Команда
                            VALIDITY_ERROR, // Поле состояния параметра
  ...
  modbusParameters_[119] = {// Необходимое напряжение отпайки
                            ...
                            5,                // Минимальное значение параметра
                            50,               // Максимально значение параметра
                            16,               // Считываемое значение "по умолчанию"
                            OFTEN,        // Частота опроса параметра
                            OFTEN,        // Количество запросов к параметру
                            OPERATION_ERROR,  // Команда
                            VALIDITY_ERROR,   // Поле состояния параметра
  ...
  modbusParameters_[120] = {// Температура пласта
                            ...
                            95,               // Считываемое значение "по умолчанию"
                            OFTEN,        // Частота опроса параметра
                            OFTEN,        // Количество запросов к параметру
                            OPERATION_ERROR,  // Команда
                            VALIDITY_ERROR,   // Поле состояния параметра
  ...
  modbusParameters_[128] = {// Среднее значение вх. напряжения
                            VSD_VOLTAGE_IN_AVARAGE,
                            18 + 0x4000,     // Адрес регистра в устройстве
                            OPERATION_WRITE,  // Операции с параметром
                            PHYSIC_VOLTAGE,   // Физическая величина параметра
                            VOLTAGE_V,        // Единицы измерения параметра
                            TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[134] = {// Прямой пуск. Режим работы
                            VSD_ETALON_DIRECT_RUN_MODE,
                            106 + 0x4000,     // Адрес регистра в устройстве
                            OPERATION_WRITE,  // Операции с параметром
                            PHYSIC_NUMERIC,   // Физическая величина параметра
                            NUMERIC_NUMBER,   // Единицы измерения параметра
                            TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[135] = {// Прямой пуск. Режим "Мягкого пуска"
                            VSD_ETALON_DIRECT_RUN_SOFT_MODE,
                            107 + 0x4000,     // Адрес регистра в устройстве
                            OPERATION_WRITE,  // Операции с параметром
                            PHYSIC_NUMERIC,   // Физическая величина параметра
                            NUMERIC_NUMBER,   // Единицы измерения параметра
                            TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[136] = {// Прямой пуск. Синхронизация с сетью
                            VSD_ETALON_DIRECT_RUN_SYNC,
                            108 + 0x4000,     // Адрес регистра в устройстве
                            OPERATION_WRITE,  // Операции с параметром
                            PHYSIC_NUMERIC,   // Физическая величина параметра
                            NUMERIC_NUMBER,   // Единицы измерения параметра
                            TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[137] = {// Прямой пуск. Команда перехода с режима на режим
                            VSD_ETALON_DIRECT_RUN_CMD_TRANSITION,
                            109 + 0x4000,     // Адрес регистра в устройстве
                            OPERATION_WRITE,  // Операции с параметром
                            PHYSIC_NUMERIC,   // Физическая величина параметра
                            NUMERIC_NUMBER,   // Единицы измерения параметра
                            TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[138] = {// Прямой пуск. Синхронизирован с сетью?
                            VSD_ETALON_DIRECT_RUN_IS_SYNC,
                            48 + 0x4000,      // Адрес регистра в устройстве
                            OPERATION_READ,   // Операции с параметром
                            PHYSIC_NUMERIC,   // Физическая величина параметра
                            NUMERIC_NUMBER,   // Единицы измерения параметра
                            TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[139] = {// Прямой пуск. Состояние перехода
                            VSD_ETALON_DIRECT_RUN_STATE_TRANSITION,
                            49 + 0x4000,      // Адрес регистра в устройстве
                            OPERATION_READ,   // Операции с параметром
                            PHYSIC_NUMERIC,   // Физическая величина параметра
                            NUMERIC_NUMBER,   // Единицы измерения параметра
                            TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[140] = {// Коэффициент коррекции тока Riz
                           VSD_COEF_RESISTANCE_ISOLATION,// Уникальный идентификатор параметра
                           133 + 0x4000,    // Адрес регистра в устройстве
                           OPERATION_WRITE, // Операции с параметром
                           PHYSIC_NUMERIC,  // Физическая величина параметра
                           NUMERIC_NUMBER,  // Единицы измерения параметра
                           TYPE_DATA_INT16, // Тип данных
