...
void VsdDanfoss::initModbusParameters()
{
  ...
  modbusParameters_[2] = {// Язык
                          VSD_LANGUAGE,     // Уникальный идентификатор параметра
                          ...
                          1,                // Коэффициент преобразования параметра
                          0,                // Минимальное значение параметра
                          49,               // Максимально значение параметра
                          0,                // Считываемое значение "по умолчанию"
                          HARDLY_EVER,      // Частота опроса параметра
                          HARDLY_EVER,      // Количество запросов к параметру
                          OPERATION_ERROR,  // Команда
  ...
  modbusParameters_[3] = {// Рабочее состояние при включении питания
  ...
  modbusParameters_[4] = {// Текущий активный набор
                          VSD_ACTIVE_SETUP, // Уникальный идентификатор параметра
  ...
  modbusParameters_[5] = {// Текущий изменяемый набор
                          VSD_PROGRAMMING_SETUP,// Уникальный идентификатор параметра
  ...
  modbusParameters_[6] = {// Набор,куда копируем изменяемый
                          VSD_SETUP_COPY,
                          509,              // Адрес регистра в устройстве
                          OPERATION_WRITE,  // Операции с параметром
                          PHYSIC_NUMERIC,   // Физическая величина параметра
                          NUMERIC_NUMBER,   // Единицы измерения параметра
                          TYPE_DATA_UINT16, // Тип данных
  ...
  modbusParameters_[7] = {// Режим конфигурирования
                          VSD_CONFIG_MODE,
  ...
  modbusParameters_[8] = {// Принцип управления двигателем
                          VSD_MOTOR_CONTROL,
  ...
  modbusParameters_[9] = {// Flux - источник ОС двигателя
                          VSD_FLUX_MOTOR_FEEDBACK_SOURCE,
                          1019,             // Адрес регистра в устройстве
                          OPERATION_WRITE,   // Операции с параметром
                          PHYSIC_NUMERIC,   // Физическая величина параметра
                          NUMERIC_NUMBER,   // Единицы измерения параметра
                          TYPE_DATA_UINT16, // Тип данных
  ...
  modbusParameters_[10] = {// Хар-ка момента нагрузки
