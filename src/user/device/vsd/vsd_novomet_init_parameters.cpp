...
void VsdNovomet::initModbusParameters()
{
  ...
  modbusParameters_[71] = {// Выходной ток ПЧ по фазе C.
                          ...
                          2500,             // Максимально значение параметра
                          0,                // Считываемое значение "по умолчанию"
                          OFTEN + 71,       // Частота опроса параметра
                          OFTEN + 71,       // Количество запросов к параметру
                          OPERATION_ERROR,  // Команда
                          VALIDITY_ERROR,   // Поле состояния параметра
                          0                 // Значение
  };
  ...
  modbusParameters_[99] = {// Ток
                          ...
                          2500,             // Максимально значение параметра
                          0,                // Считываемое значение "по умолчанию"
                          OFTEN + 99,       // Частота опроса параметра
                          OFTEN + 99,       // Количество запросов к параметру
                          OPERATION_ERROR,  // Команда
                          VALIDITY_ERROR,   // Поле состояния параметра
                          0                 // Значение
  };
  ...
  modbusParameters_[123] = {// Постоянная времени перегрузки ПЧ
                          ...
                          4000,             // Максимально значение параметра
                          50,               // Считываемое значение "по умолчанию"
                          OFTEN + 123,      // Частота опроса параметра
                          OFTEN + 123,      // Количество запросов к параметру
                          OPERATION_ERROR,  // Команда
                          VALIDITY_ERROR,   // Поле состояния параметра
                          0                 // Значение
  };
  ...
  modbusParameters_[135] = {// Макс. величина перегрузки для ПЧ
                          VSD_CURRENT_LIMIT,
