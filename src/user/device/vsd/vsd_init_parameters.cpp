...
void Vsd::initParameters()
{
  ...
  parameters_[VSD_MOTOR_TYPE - VSD_BEGIN].code                                   = 13;
  ...
  parameters_[VSD_DOUTPUTS - VSD_BEGIN].operation                                = 0;
  parameters_[VSD_DOUTPUTS - VSD_BEGIN].physic                                   = 0;
  ...
  parameters_[VSD_DINPUTS - VSD_BEGIN].operation                                 = 0;
  parameters_[VSD_DINPUTS - VSD_BEGIN].physic                                    = 0;
  ...
  parameters_[VSD_DOUTPUTS_ENABLE - VSD_BEGIN].operation                         = 0;
  parameters_[VSD_DOUTPUTS_ENABLE - VSD_BEGIN].physic                            = 0;
  ...
  parameters_[VSD_DOUTPUTS_DISABLE - VSD_BEGIN].operation                        = 0;
  parameters_[VSD_DOUTPUTS_DISABLE - VSD_BEGIN].physic                           = 0;
  ...
  parameters_[VSD_VENT_ON_TEMPERATURE - VSD_BEGIN].operation                     = 0;
  parameters_[VSD_VENT_ON_TEMPERATURE - VSD_BEGIN].physic                        = 0;
  ...
  parameters_[VSD_VENT_OFF_TEMPERATURE - VSD_BEGIN].operation                    = 0;
  parameters_[VSD_VENT_OFF_TEMPERATURE - VSD_BEGIN].physic                       = 0;
  ...
  parameters_[VSD_VENT_PERIOD - VSD_BEGIN].operation                             = 0;
  parameters_[VSD_VENT_PERIOD - VSD_BEGIN].physic                                = 0;
  ...
  parameters_[VSD_VENT_TEMPERATURE_FAULT - VSD_BEGIN].operation                  = 0;
  parameters_[VSD_VENT_TEMPERATURE_FAULT - VSD_BEGIN].physic                     = 0;
  ...
  parameters_[VSD_INVERTOR_CONTROL - VSD_BEGIN].operation                        = 0;
  parameters_[VSD_INVERTOR_CONTROL - VSD_BEGIN].physic                           = 0;
  ...
  parameters_[VSD_FREQUENCY_ERROR - VSD_BEGIN].operation                         = 0;
  ...
  parameters_[VSD_U_SCALE - VSD_BEGIN].operation                                 = 0;
  parameters_[VSD_U_SCALE - VSD_BEGIN].physic                                    = 0;
  ...
  parameters_[VSD_I_SCALE - VSD_BEGIN].operation                                 = 0;
  parameters_[VSD_I_SCALE - VSD_BEGIN].physic                                    = 0;
  ...
  parameters_[VSD_COMMAND_WORD - VSD_BEGIN].operation                            = 0;
  parameters_[VSD_COMMAND_WORD - VSD_BEGIN].physic                               = 0;
  ...
  parameters_[VSD_COMMAND_WORD - VSD_BEGIN].discret                              = 1;
  ...
  parameters_[VSD_STATUS_WORD - VSD_BEGIN].operation                             = 0;
  parameters_[VSD_STATUS_WORD - VSD_BEGIN].physic                                = 0;
  ...
  parameters_[VSD_STATUS_WORD - VSD_BEGIN].discret                               = 1;
  ...
  // Запуск
  parameters_[VSD_ETALON_ON - VSD_BEGIN].id                                      = VSD_ETALON_ON;
  parameters_[VSD_ETALON_ON - VSD_BEGIN].access                                  = ACCESS_OPERATOR;
  parameters_[VSD_ETALON_ON - VSD_BEGIN].operation                               = OPERATION_WRITE;
  parameters_[VSD_ETALON_ON - VSD_BEGIN].physic                                  = PHYSIC_NUMERIC;
  parameters_[VSD_ETALON_ON - VSD_BEGIN].validity                                = VALIDITY_ERROR;
  parameters_[VSD_ETALON_ON - VSD_BEGIN].value.float_t                           = 0.0;
  parameters_[VSD_ETALON_ON - VSD_BEGIN].min                                     = 0.0;
  parameters_[VSD_ETALON_ON - VSD_BEGIN].max                                     = 1.0;
  parameters_[VSD_ETALON_ON - VSD_BEGIN].def                                     = 0.0;
  parameters_[VSD_ETALON_ON - VSD_BEGIN].discret                                 = 1;
  parameters_[VSD_ETALON_ON - VSD_BEGIN].code                                    = 0;
  // Останов
  parameters_[VSD_ETALON_OFF - VSD_BEGIN].id                                     = VSD_ETALON_OFF;
  parameters_[VSD_ETALON_OFF - VSD_BEGIN].access                                 = ACCESS_OPERATOR;
  parameters_[VSD_ETALON_OFF - VSD_BEGIN].operation                              = OPERATION_WRITE;
  parameters_[VSD_ETALON_OFF - VSD_BEGIN].physic                                 = PHYSIC_NUMERIC;
  parameters_[VSD_ETALON_OFF - VSD_BEGIN].validity                               = VALIDITY_ERROR;
  parameters_[VSD_ETALON_OFF - VSD_BEGIN].value.float_t                          = 0.0;
  parameters_[VSD_ETALON_OFF - VSD_BEGIN].min                                    = 0.0;
  parameters_[VSD_ETALON_OFF - VSD_BEGIN].max                                    = 1.0;
  parameters_[VSD_ETALON_OFF - VSD_BEGIN].def                                    = 0.0;
  parameters_[VSD_ETALON_OFF - VSD_BEGIN].discret                                = 1;
  parameters_[VSD_ETALON_OFF - VSD_BEGIN].code                                   = 0;
