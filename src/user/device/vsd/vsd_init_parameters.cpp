...
void Vsd::initParameters()
{
  ...
  parameters_[VSD_MIN_REFERENCE - VSD_BEGIN].min                                 = -1999999.999;
  parameters_[VSD_MIN_REFERENCE - VSD_BEGIN].max                                 = 1999999.999;
  ...
  parameters_[VSD_MAX_REFERENCE - VSD_BEGIN].min                                 = -1999999.999;
  parameters_[VSD_MAX_REFERENCE - VSD_BEGIN].max                                 = 1999999.999;
