...
void VsdNovomet::initModbusParameters()
{
  ...
  modbusParameters_[135] = {// Максимальное допустимое отклонение частоты вектороного режима
                          VSD_MAX_VC_DF,
                          211,              // 0x00D3 Адрес регистра в устройстве
                          OPERATION_WRITE,  // Операции с параметром
                          PHYSIC_FREQUENCY, // Физическая величина параметра
                          FREQUENCY_HZ,     // Единицы измерения параметра
                          TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[137] = {// Расширенный регистр управления
                          VSD_CONTROL_WORD_2,
                          213,              // 0x00D5 Адрес регистра в устройстве
                          OPERATION_WRITE,  // Операции с параметром
                          PHYSIC_NUMERIC,   // Физическая величина параметра
                          NUMERIC_NUMBER,   // Единицы измерения параметра
                          TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[138] = {// Коэффициент усиления интегральной ОС системы подавления резонанса
                          VSD_RES_INT_GAIN,
                          214,              // 0x00D6 Адрес регистра в устройстве
                          OPERATION_WRITE,  // Операции с параметром
                          PHYSIC_NUMERIC,   // Физическая величина параметра
                          NUMERIC_NUMBER,   // Единицы измерения параметра
                          TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[139] = {// Не используется
                          VSD_STARTUP_I_LIM_MAX_F,
                          215,              // 0x00D7 Адрес регистра в устройстве
                          OPERATION_WRITE,  // Операции с параметром
                          PHYSIC_FREQUENCY, // Физическая величина параметра
                          FREQUENCY_HZ,     // Единицы измерения параметра
                          TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[140] = {// Мгновенная активная мощность
                          VSD_POWER_ACTIVE_NOW,
                          216,              // 0x00D8 Адрес регистра в устройстве
                          OPERATION_READ,   // Операции с параметром
  ...
  modbusParameters_[141] = {// Мгновенный момент
                          VSD_RATE_OUT_NOW,
                          217,              // 0x00D9 Адрес регистра в устройстве
                          OPERATION_READ,   // Операции с параметром
  ...
  modbusParameters_[142] = {// Ток при частоте 0Гц
                          VSD_IF_I_0,
                          218,              // 0x00DA Адрес регистра в устройстве
                          OPERATION_WRITE,  // Операции с параметром
                          PHYSIC_CURRENT,   // Физическая величина параметра
                          CURRENT_A,        // Единицы измерения параметра
                          TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[143] = {// Ток при частоте в точке VSD_UF_CHARACTERISTIC_F_1
                          VSD_IF_I_1,
                          219,              // 0x00DB Адрес регистра в устройстве
                          OPERATION_WRITE,  // Операции с параметром
                          PHYSIC_CURRENT,   // Физическая величина параметра
                          CURRENT_A,        // Единицы измерения параметра
                          TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[144] = {// Ток при частоте в точке VSD_UF_CHARACTERISTIC_F2
                          VSD_IF_I_2,
                          220,              // 0x00DC Адрес регистра в устройстве
                          OPERATION_WRITE,  // Операции с параметром
                          PHYSIC_CURRENT,   // Физическая величина параметра
                          CURRENT_A,        // Единицы измерения параметра
                          TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[145] = {// Ток при частоте в точке VSD_UF_CHARACTERISTIC_F3
                          VSD_IF_I_3,
                          221,              // 0x00DD Адрес регистра в устройстве
                          OPERATION_WRITE,  // Операции с параметром
                          PHYSIC_CURRENT,   // Физическая величина параметра
                          CURRENT_A,        // Единицы измерения параметра
                          TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[146] = {// Ток при частоте в точке VSD_UF_CHARACTERISTIC_F4
                          VSD_IF_I_4,
                          222,              // 0x00DE Адрес регистра в устройстве
                          OPERATION_WRITE,  // Операции с параметром
                          PHYSIC_CURRENT,   // Физическая величина параметра
                          CURRENT_A,        // Единицы измерения параметра
                          TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[147] = {// Ток при частоте в точке VSD_UF_CHARACTERISTIC_F5
                          VSD_IF_I_5,
                          223,              // 0x00DF Адрес регистра в устройстве
                          OPERATION_WRITE,  // Операции с параметром
                          PHYSIC_CURRENT,   // Физическая величина параметра
                          CURRENT_A,        // Единицы измерения параметра
                          TYPE_DATA_INT16,  // Тип данных
  ...
  modbusParameters_[148] = {// Ток при частоте в точке VSD_UF_CHARACTERISTIC_F6
                          VSD_IF_I_6,
                          224,              // 0x00DF Адрес регистра в устройстве
                          OPERATION_WRITE,  // Операции с параметром
                          PHYSIC_CURRENT,   // Физическая величина параметра
                          CURRENT_A,        // Единицы измерения параметра
                          TYPE_DATA_INT16,  // Тип данных
