...
void TmsNovomet::initModbusParameters()
{
  ...
  modbusParameters_[19] = {// Виброускорение результирующий вектор
  ...
  modbusParameters_[20] = {// Виброускорение радиальное на приёме
  ...
  modbusParameters_[21] = {// Виброускорение осевое на приёме
