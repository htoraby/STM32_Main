...
void TmsZenith::initModbusParameters()
{
  ...
  modbusParameters_[1] = { // Pi - Давление жидкости на приёме
                           TMS_PRESSURE_INTAKE,
                           ...
                           400.0,           // Максимально значение параметра
  ...
  modbusParameters_[2] = { // Pd - Давление жидкости на выкиде
  ...
  modbusParameters_[3] = { // Ti - температура на приёме
  ...
  modbusParameters_[4] = { // Тm - температура двигателя
                           ...
                           0.1,             // Коэффициент преобразования параметра
                           0.0,             // Минимальное значение параметра
                           2040.0,          // Максимально значение параметра
                           0.0,             // Считываемое значение "по умолчанию"
                           EVERY_TIME,      // Частота опроса параметра
                           EVERY_TIME,      // Количество запросов к параметру
                           OPERATION_ERROR, // Команда
  ...
  modbusParameters_[5] = { // Vх - вибрация в поперечной плоскости
  ...
  modbusParameters_[6] = { // Vz - вибрация в продольной плоскости
  ...
  modbusParameters_[7] = { // Ct - Tool Current
                           TMS_TOOL_CURRENT,          // Идентификатор параметра
  ...
  modbusParameters_[8] = { // Vt - Tool Voltage
                           TMS_TOOL_VOLTAGE,          // Идентификатор параметра
  ...
  modbusParameters_[9] = { // Pi2 - Давление жидкости на приёме 2
                           TMS_PRESSURE_INTAKE_2,
                           9,               // Адрес регистра в устройстве
                           OPERATION_READ,  // Операции с параметром
                           PHYSIC_PRESSURE, // Физическая величина параметра
                           PRESSURE_PSI,    // Единицы измерения параметра
                           TYPE_DATA_INT16, // Тип данных
                           0,               // Индекс
                           0.1,             // Коэффициент преобразования параметра
                           0.0,             // Минимальное значение параметра
  ...
  modbusParameters_[10] = { // Pd2 - Давление жидкости на выкиде 2
                           TMS_PRESSURE_DISCHARGE_2,
  ...
  modbusParameters_[11] = { // Ti2 - температура на приёме 2
                           TMS_TEMPERATURE_INTAKE_2,
                           11,              // Адрес регистра в устройстве
                           OPERATION_READ,  // Операции с параметром
                           PHYSIC_TEMPERATURE,
                           TEMPERATURE_F,   // Единицы измерения параметра
                           TYPE_DATA_INT16, // Тип данных
                           0,               // Индекс
                           0.1,             // Коэффициент преобразования параметра
                           0.0,             // Минимальное значение параметра
                           3020.0,          // Максимально значение параметра
                           0.0,             // Считываемое значение "по умолчанию"
                           VERY_OFTEN,      // Частота опроса параметра
                           VERY_OFTEN,      // Количество запросов к параметру
                           OPERATION_ERROR, // Команда
  ...
  modbusParameters_[12] = { // Тm2 - температура двигателя 2
                           TMS_TEMPERATURE_WINDING_2,
...
void TmsZenith::getNewValue(uint16_t id)
{
  float value = 0;
...
uint8_t TmsZenith::setNewValue(uint16_t id, float value, EventType eventType)
{
  switch (id) {
  default:
...
void TmsZenith::writeToDevice(int id, float value)
{
  dm_->writeModbusParameter(id, value);
}

bool TmsZenith::isConnect()
{
...
void TmsZenith::getConnect()
{
  Tms::setConnect(dm_->getMms()->getCounters());
}

void TmsZenith::resetConnect()
{
  Tms::resetConnect();
