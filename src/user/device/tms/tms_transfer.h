#ifndef TMSTRANSFER_H
#define TMSTRANSFER_H

#include "tms.h"
#include "device_modbus.h"

/*!
 * \brief Класс системы телеметрической "РН-Transfer"
 */
class TmsTransfer : public Tms
{
public:
  TmsTransfer();
  ~TmsTransfer();
...
private:
  ModbusParameter modbusParameters_[38];
  DeviceModbus *dm_;
